...
public class RegicideFSM extends FSM{
	...
	public void hardAiFetchAction() {
		...
		else if(  calc.getKing().equals(aiPlayer) || (aiPlayerHP < (maxHP/2) && aiPlayerHP<playerHP) || calc.someoneCloseIsCharging() || calc.isCharging(nearestPlayer) || (calc.getWinningPlayer().equals(aiPlayer) && playerHP-aiPlayerHP > 20)  ) {
			aiCon.setState(AiStates.ESCAPE);
		}
