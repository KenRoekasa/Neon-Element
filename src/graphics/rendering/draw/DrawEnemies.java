...
public class DrawEnemies {
    ...
    public static void drawEnemy(GraphicsContext gc, Rectangle stage, Character enemy, Player player) {
    ...
    public static void drawerEnemyCursor(GraphicsContext gc, Rectangle stage, Character enemy, Player player) {
        Point2D relativeLocation = getRelativeLocation(stage, enemy.getLocation(), player.getLocation());
        DrawPlayers.drawCursor(gc, relativeLocation, enemy);
    }


    public static void drawLightAttack(GraphicsContext gc, Character enemy, Player player, long remainingAnimDuration, long animationDuration, Rectangle stage) {
        Point2D relativeLocation = getRelativeLocation(stage, enemy.getLocation(), player.getLocation());
        DrawStates.drawLightAttack(gc, enemy, remainingAnimDuration, animationDuration, relativeLocation);
    }


    public static void drawHeavyAttackCharge(GraphicsContext gc, Character enemy, Player player, long remainingAnimDuration, long animationDuration, Rectangle stage) {
        Point2D relativeLocation = getRelativeLocation(stage, enemy.getLocation(), player.getLocation());
        DrawStates.drawHeavyAttackCharge(gc, enemy, remainingAnimDuration, animationDuration, relativeLocation);
    }


    public static void drawHeavyAttack(GraphicsContext gc, Character enemy, Player player, long remainingAnimDuration, long animationDuration, Rectangle stage) {
        Point2D relativeLocation = getRelativeLocation(stage, enemy.getLocation(), player.getLocation());
