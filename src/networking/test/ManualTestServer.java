...
public class ManualTestServer {
    public static void main(String[] args) throws IOException {
        ...
        ServerGameState gameState = new ServerGameState(clientGameState.getMap(), clientGameState.getDeadPlayers(),clientGameState.getObjects(), clientGameState.getScoreBoard(),clientGameState.getGameType(),clientGameState.getAiConMan());
